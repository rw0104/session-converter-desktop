...
(() => {
  ...
  const SOURCE_PINS = Object.freeze([
    Object.freeze({
      ...
      branch: "main",
      shortSha: "42a00a2a",
      fullSha: "42a00a2a6521b867c27f7ad096d08699db8e6d19",
      date: "2026-07-26",
      repoUrl: "https://github.com/router-for-me/CLIProxyAPI",
      commitUrl: "https://github.com/router-for-me/CLIProxyAPI/commit/42a00a2a6521b867c27f7ad096d08699db8e6d19",
    }),
    Object.freeze({
      id: "sub2api",
      label: "sub2api",
      branch: "main",
      shortSha: "2730c1c4",
      fullSha: "2730c1c43b29be003925b033f3f9e645e726bb8c",
      date: "2026-07-25",
      repoUrl: "https://github.com/Wei-Shaw/sub2api",
      commitUrl: "https://github.com/Wei-Shaw/sub2api/commit/2730c1c43b29be003925b033f3f9e645e726bb8c",
    }),
  ]);
  ...
  function buildSubToCpa(entries, now = new Date()) {
    ...
    return {
      ...
      skipped,
      output,
      downloadKind: accounts.length > 1 ? "zip" : "json",
      fileName: accounts.length > 1 ? "cliproxyapi-auth-files.zip" : (cpaFiles[0]?.name || "codex-account.json"),
      cpaFiles,
      sub2apiFiles: [],
      accountCount: accounts.length,
  ...
  function convertBridgeText(text, direction, sourceName = "pasted-json") {
    ...
    if (!parsed.entries.length && baseSkipped.length) {
      return {
        ...
        output: null,
        downloadKind: "json",
        fileName: direction === "sub-to-cpa" ? "cliproxyapi-auth-files.zip" : "sub2api-import.json",
        cpaFiles: [],
        sub2apiFiles: [],
        accountCount: 0,
      };
