...
| `public/tools/session-converter/index.html` | `src/index.html` | 去除 VaultKey 站点导航和商业推广，改为独立桌面产品文案 |
...
- VaultKey 兑换、库存、管理后台、数据库和上传逻辑
- VaultKey 静态服务与 `/api/tools/session-health` 路由
- GPT 账号商业推广入口
- 服务端限流与部署脚本
